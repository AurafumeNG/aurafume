    ...
    <div className="space-y-4">
          ...
          <div className="relative">
            <button
              ...
              style={{
                ...
                border: `1px solid ${GOLD_BG(0.30)}`,
                color: GOLD,
              }}
              onMouseEnter={(e) => {
                e.currentTarget.style.background = GOLD_BG(0.18);
              }}
              onMouseLeave={(e) => {
                e.currentTarget.style.background = GOLD_BG(0.12);
              }}
            >
      ...
      >
        ...
        <div className="flex flex-wrap items-center gap-3">
          <div className="flex items-center gap-2">
            <span className="text-[0.48rem] tracking-[0.12em] uppercase" style={{ color: TEXT.muted }}>
              From
            </span>
            <input
              type="date"
              ...
              className="h-7 px-2.5 text-[0.50rem] tracking-[0.04em] outline-none"
              style={{
