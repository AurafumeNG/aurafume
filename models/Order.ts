...
export interface IOrderPayment {
  ...
  proofUrl?:        string;  // Cloudinary URL of uploaded proof of payment
  verifiedAt?:      Date;    // when admin confirmed the bank transfer
  rejectedAt?:      Date;    // when admin rejected the bank transfer
  actionedBy?:      string;  // admin name who verified/rejected
  rejectionReason?: string;  // reason given when rejecting
}
...
const DeliverySchema = new Schema<IOrderDelivery>(
  {
    option: {
      type: String,
      enum: ['outside-lagos', 'within-lagos', 'pickup'],
      required: true,
    },
